...
export const RightInfoPanel: React.FC = () => {
  ...
  return (
    <aside style={{
      ...
      <div className="surface-card" style={{
        ...
        {activeVarInfo ? (
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem', fontSize: '0.75rem' }}>
            ...
            {activeVarInfo.standard_name && (
              <div>
                <span style={{ color: 'var(--text-muted)' }}>Standard Name: </span>
                <span style={{ color: 'var(--text-secondary)' }}>{activeVarInfo.standard_name}</span>
              </div>
            )}
            {activeVarInfo.long_name && (
              <div>
                <span style={{ color: 'var(--text-muted)' }}>Long Name: </span>
                <span style={{ color: 'var(--text-secondary)' }}>{activeVarInfo.long_name}</span>
              </div>
            )}
            <div>
      ...
      {/* 2. Scientific Distribution Statistics (Phase 7 API) */}
      <div className="surface-card" style={{
        padding: '0.875rem',
        backgroundColor: 'var(--bg-surface)',
        borderRadius: 'var(--radius-sm)',
      ...
      {/* 3. Phase 7 Dataset Analysis Summary */}
      {summaryAnalysis && (
        <div className="surface-card" style={{
          padding: '0.875rem',
          backgroundColor: 'var(--bg-surface)',
        ...
        {dataset ? (
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem', fontSize: '0.75rem' }}>
            <div>
              ...
              <span style={{ color: 'var(--text-secondary)' }}>{dataset.source || 'Standard'}</span>
            </div>
            {spatial && (
              <div>
                <span style={{ color: 'var(--text-muted)' }}>Spatial Extent: </span>
